...
4. 서론(이 문제가 왜 생기는지) - 소제목 5~7개(각각 다른 각도에서, 구체적인
   설명과 실천 항목) - 결론 구조를 지키십시오.

5. 결론의 소제목은 주제에 맞게 직접 지으십시오. "마무리", "결론" 같은
   일반적인 단어를 그대로 쓰지 마십시오.

6. 과장 광고나 근거 없는 의학적·재무적 단정을 피하고, 확실하지 않은 것은
   "경우에 따라 다르다"고 정직하게 쓰십시오.

7. 산문(서론+각 섹션 본문+결론)의 합계가 1,600자를 넘도록 충분히 상세하게
   쓰십시오. 다만 **분량을 채우려고 수치를 지어내는 것은 최악입니다.**
   분량이 모자라면 확인 절차와 주의점을 더 풀어 쓰십시오.

8. 아래 JSON 스키마 그대로만 반환하십시오 (마크다운 코드블록이나 설명 문장 금지).
